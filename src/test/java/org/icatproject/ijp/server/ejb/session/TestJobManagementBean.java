...
public class TestJobManagementBean {
	...
	public void testOneQuote() throws Exception {
		assertEquals("'a' 'o'" + sq + "'brien' '1'",
				JobManagementBean.escaped(Arrays.asList("a", "o'brien", "1")));
	}

	@Test
	public void testOneQuoteTwice() throws Exception {
		assertEquals("'a' 'o'" + sq + "'brie'" + sq + "'n' '1'",
				JobManagementBean.escaped(Arrays.asList("a", "o'brie'n", "1")));
	}

	@Test
	public void testDoubleQuote() throws Exception {
		assertEquals("'a' 'o'" + sq + sq + "'brien' '1'",
				JobManagementBean.escaped(Arrays.asList("a", "o''brien", "1")));
	}

	@Test
	public void testJustThreeQuotes() throws Exception {
		assertEquals("'a' " + sq + sq + sq + " '1'",
				JobManagementBean.escaped(Arrays.asList("a", "'''", "1")));
	}
}